#Node-red에서 데이터 파싱이 어려워 토픽들을 나누어 데이터 전송
...
# MQTT 설정
mqtt_broker = "192.168.35.143"  # 예: "localhost" 또는 브로커의 올바른 호스트 이름/주소
mqtt_port = 1883
...
try:
    while True:
        ...
        print("Distance3: {:.2f} cm".format(round(distance3,2)))
        print("Humidity(%) : ", round(humid,2))
        ...
        #    'temperature': round(temp - 12,2)  # 온도 보정
        #}
        ...
        client.publish(mqtt_topic_light, light_sensor.value)
